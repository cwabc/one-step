...
import com.example.administrator.Frame.ShareActivity;
...
public class ditu extends AppCompatActivity implements View.OnClickListener ,
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        ToastUtil.show(ditu.this,
                                R.string.no_result);
                    }
                }
            } else {
                ToastUtil
                        .show(ditu.this, R.string.no_result);
            }
        } else  {
            ...
            if (amapLocation != null) {
                if (amapLocation.getErrorCode() == 0) {
                    ...
                    if (amapLocation.getLocationType() == 1&&start_draw) {
                        ...
                        count++;
                        distance += distance;
                        Toast.makeText(ditu.this, "经纬度"+distance+"KM",Toast.LENGTH_SHORT).show();
